...
* geen extra API-endpoints buiten wat aantoonbaar bestaat, inclusief de huidige read-only health/status/mock/classification/proposal/mapping/preview/review-routes
